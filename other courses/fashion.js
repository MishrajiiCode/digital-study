...
const featureData = {
    fashion: {
        ...
        options: ['Diploma in Fashion Technology', 'Bachelor in Fashion Technology'],
    },
        ...
        data.options.forEach((option) => {
            ...
            button.addEventListener('click', () => {
                ...
                switch (option.toLowerCase()) {
                    case "diploma in fashion technology":
                        location.href = 'diploma.html';  // Adjust the path if needed
                        break;
                    case "bachelor in fashion technology":
                        location.href = 'bachelor.html';  // Adjust the path if needed
                        break;
                    case "puja":
